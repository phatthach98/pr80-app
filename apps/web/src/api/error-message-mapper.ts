...
export const ErrorMessageMapper: Record<ErrorCode, string> = {
  ...
  [ErrorCode.BAD_GATEWAY]: 'Bad gateway. The server is temporarily unavailable.',
  [ErrorCode.GATEWAY_TIMEOUT]: 'Gateway timeout. The server took too long to respond.',
  ...
  [ErrorCode.REQUEST_CANCELED]: 'Request was cancelled.',
  [ErrorCode.REQUEST_CONFIG_ERROR]: 'Request configuration error. Please try again.',
